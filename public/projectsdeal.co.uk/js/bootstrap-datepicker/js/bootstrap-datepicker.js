(function($) {
                ...
                if (prevMonth.getUTCDay() == this.o.weekStart) {
                    ...
                    if (this.o.calendarWeeks) {
                        var ws = new Date(+prevMonth + (this.o.weekStart - prevMonth.getUTCDay() - 7) % 7 * 86400000),
                            th = new Date(+ws + (7 + 4 - ws.getUTCDay()) % 7 * 86400000),
                            yth = new Date(+(yth = UTCDate(th.getUTCFullYear(), 0, 1)) + (7 + 4 - yth.getUTCDay()) % 7 * 86400000),
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="glyphicon glyphicon-chevron-left"></i></th><th colspan="5" class="datepicker-switch"></th><th class="next"><i class="glyphicon glyphicon-chevron-right"></i></th></tr></thead>',
