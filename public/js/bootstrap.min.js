if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    var ut = function(t) {
        ...
        w = e.support = {}, E = e.isXML = function(t) {
            ...
            preFilter: {
                ...
                CHILD: function(t) {
                    return t[1] = t[1].toLowerCase(), "nth" === t[1].slice(0, 3) ? (t[3] || e.error(t[0]), t[4] = +(t[4] ? t[5] + (t[6] || 1) : 2 * ("even" === t[3] || "odd" === t[3])), t[5] = +(t[7] + t[8] || "odd" === t[3])) : t[3] && e.error(t[0]),
                        t
                },
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
    ...
    ot.event = {
        ...
        trigger: function(e, n, i, o) {
            ...
            if (a = c = i = i || ht, 3 !== i.nodeType && 8 !== i.nodeType && !It.test(f + ot.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), s = f.indexOf(":") < 0 && "on" + f, e = e[ot.expando] ? e : new ot.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ot.makeArray(n, [e]), u = ot.event.special[f] || {}, o || !u.trigger || u.trigger.apply(i, n) !== !1)) {
    ...
    Jt.optgroup = Jt.option, Jt.tbody = Jt.tfoot = Jt.colgroup = Jt.caption = Jt.thead, Jt.th = Jt.td, ot.extend({
        ...
        buildFragment: function(t, e, n, i) {
            ...
            for (a && p.removeChild(a), nt.appendChecked || ot.grep(m(f, "input"), v),
                h = 0; r = f[h++];)
    ...
    ot.fn.extend({
        ...
        attr: function(t, e, n) {
            var i, o, r = t.nodeType;
            return t && 3 !== r && 8 !== r && 2 !== r ? typeof t.getAttribute === Ct ? ot.prop(t, e, n) : (1 === r && ot.isXMLDoc(t) || (e = e.toLowerCase(), i = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? Te : we)), void 0 === n ? i && "get" in i && null !== (o = i.get(t, e)) ? o : (o = ot.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void ot.removeAttr(t, e)) : void 0
        },
    ...
    ot.offset = {
        ...
        offset: function(t) {
            ...
            var e, n, i = {
                ...
                o = this[0],
                r = o && o.ownerDocument;
            return r ? (e = r.documentElement, ot.contains(e, o) ? (typeof o.getBoundingClientRect !== Ct && (i = o.getBoundingClientRect()), n = V(r), {
